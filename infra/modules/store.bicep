...
var containerAppName = 'store'

resource inventory 'Microsoft.App/containerApps@2022-03-01' existing = {
  name: '${name}inventory'
}

resource products 'Microsoft.App/containerApps@2022-03-01' existing = {
  name: '${name}products'
}
      ...
      containers: [
        {
          ...
          env: [
            ...
            {
              name: 'InventoryApi'
              value: 'https://${inventory.properties.configuration.ingress.fqdn}'
            }
            {
              name: 'ProductsApi'
              value: 'https://${products.properties.configuration.ingress.fqdn}'
            }
          ]
        }
      ]
